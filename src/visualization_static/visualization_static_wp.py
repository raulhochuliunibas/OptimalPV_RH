...
class static_plotter_class:
    ...
    def plot_ind_line_demand(self,
        ...
        for variant in plot_variants:
            ...
            if export_plots:
                ...
                plt.legend()
                plt.tight_layout()
                plt.savefig(os.path.join(self.dir_path_export, f"{export_name}{suffix}.png"), dpi=500)
                plt.close() 
    ...
    def NPVhist_DataSampleSummary(self, 
        ...
        if True: 
            ...
            plt.tight_layout()
            # plt.show()
            plt.savefig(os.path.join(self.dir_path_export, f'{scen}_npv_df_hist.png'), dpi=500)
            plt.close()
        ...
        if True:
            ...
            plotter._write_latex_from_template(
    ...
    def plot_productionHOY_per_node(self, 
        ...
        plt.tight_layout()
        # plt.show()
        plt.savefig(os.path.join(self.dir_path_export, f'{export_name}.png'), dpi=500)
    ...
    def plot_productionHOY_per_node_byiter(self, 
        ...
        plt.tight_layout()
        # plt.show()
        plt.savefig(os.path.join(self.dir_path_export, f'{export_name}.png'), dpi= 300)    
    ...
    def plot_ind_hist_contcharact_newinst(self,
        ...
        for scen in scen_incl_list:
            ...
            plt.savefig(os.path.join(self.dir_path_export, export_file), dpi=500)
            plt.close()
...
if __name__ == "__main__":
    ...
    if True: 
        ...
        print(' = BU case =====================')
        plotter = static_plotter_class()
        # print('- BU: plot_productionHOY_per_node')
        # plotter.plot_productionHOY_per_node(
        #     # csv_file='plot_agg_line_productionHOY_per_node___export_plot_data___1scen.csv',
        #     csv_file='plot_agg_line_productionHOY_per_node___export_plot_data___21scen.csv',
        ...
        # )
        print('- BU: plot_productionHOY_per_node_byiter')
        plotter.plot_productionHOY_per_node_byiter(
            csv_file='plot_agg_line_productionHOY_per_node_byiter___export_plot_data___21scen.csv',
            scen_incl_list=['pvalloc_29nbfs_LRG2_max',],
            hours_incl_list=list(range(4920 + 3*24, 4920 + 6*24)),
            iter_incl_list=[ '7', '8', ], #'end_iter'],
    ...
    if True: 
        ...
        #                     ],
        #     n_iter_range_list=[4, 5, 6, 7, 8, 9, 10, 11, 12],
        #     export_name='line_PVproduction_bu_capacity',
        #     y_col='TotalPower',
        #     y_scaling= 1000,
        #     y_label='Inst. PV Capacity (MW)',
            # title='Inst. PV Capacity',
        # )
        ...
        plotter.plot_PVproduction_line(
            ...
            y_scaling= 1000,    
            y_label='Aggregated Feed-in (MWh)',
            title='Agg. Feed-in',
        ...
        plotter.plot_PVproduction_line(
            ...
            n_iter_range_list=[4, 5, 6, 7, 8, 9, 10, 11, 12, ],
            export_name='line_PVproduction_DSOreact_loss',
            y_col='feedin_atnode_loss_kW',
            y_scaling= 1000,
            y_label='Aggregated Loss (MWh)',
            title='Agg. Loss',
        ...
        plotter.plot_PVproduction_line(
            ...
            n_iter_range_list=[4, 5, 6, 7, 8, 9, 10, 11, 12, ],
            export_name='line_PVproduction_gridoptim_loss',
            y_col='feedin_atnode_loss_kW',
            y_scaling= 1000,
            y_label='Aggregated Loss (MWh)',
            title='Agg. Loss',
