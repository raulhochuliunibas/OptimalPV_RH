...
\begin{frame}{Motivation}
  \centering
  \makebox[0pt][c]{%
    \includegraphics[width=0.9841\textwidth]{paper_publication/SSES_StGallen/newspaper_header3.png}
  }
\vspace{-0.25cm}
...
\vspace{0.01cm}
\makebox[0pt][c]{%
  \includegraphics[width=0.751\textwidth]{SSES_StGallen/figures/grid-levels.png}
}
\end{frame}
...
\begin{minipage}{0.48\textwidth}
  \centering\includegraphics[width=\textwidth]{SSES_StGallen/figures/line_PVproduction_bauABC_excfeedin.png}
\end{minipage}\hfill
\begin{minipage}{0.48\textwidth}
  \centering\includegraphics[width=\textwidth]{SSES_StGallen/figures/line_PVproduction_bauABC_feedin.png}
\end{minipage}
\end{frame}
