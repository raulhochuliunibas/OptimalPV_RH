...
\begin{column}{0.49\textwidth}
  ...
  \begin{figure}
    ...
    \only<3->{\includegraphics[width=0.91\linewidth]{figures/plot_EGID_HOY_pvprod_demand_feedin.png}}%
  \end{figure}
\end{column}
...
\begin{minipage}{0.48\textwidth}
  \centering\includegraphics[width=\textwidth]{figures/pvalloc_LRG3_max_elecpri15RP_npv_df_hist.png}
\end{minipage}\hfill
\begin{minipage}{0.48\textwidth}
  \centering\includegraphics[width=\textwidth]{figures/pvalloc_LRG3_max_elecpri60RP_npv_df_hist.png}
\end{minipage}
\centering
