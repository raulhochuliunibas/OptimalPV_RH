...
\addbibresource{econ_lunch_bib.bib}
...
% =======================================
\begin{frame}{Simulation Framework - 3 Agents }
\hypertarget{mod_structure_agents}{}

\begin{columns}
    \begin{column}{0.49\textwidth}    
    \textcolor{violet}{Production}
    \begin{itemize}
...
\begin{minipage}{0.322\textwidth}
  \centering
  \makebox[0pt][c]{%
    \includegraphics[width=1.005\textwidth]{figures/gridnode_feedin_threshold_HOY.png}
  }
\end{minipage}\hfill
\begin{minipage}{0.322\textwidth}
  \centering
  \makebox[0pt][c]{%
    \includegraphics[width=1.005\textwidth]{figures/line_PVproduction_bau_excfeedin.png}
  }
\end{minipage}\hfill
\begin{minipage}{0.322\textwidth}
  \centering
  \makebox[0pt][c]{%
    \includegraphics[width=1.005\textwidth]{figures/line_PVproduction_bau_feedin.png}
  }
\end{minipage}
\end{frame}
...
\begin{minipage}{0.492\textwidth}
  \centering
  \makebox[0pt][c]{%
    \includegraphics[width=1.005\textwidth]{figures/line_PVproduction_bauABC_excfeedin.png}
  }
\end{minipage}\hfill
\begin{minipage}{0.492\textwidth}
  \centering
  \makebox[0pt][c]{%
    \includegraphics[width=1.005\textwidth]{figures/line_PVproduction_bauABC_feedin.png}
  }
\end{minipage}
\end{frame}
...
\begin{minipage}{0.492\textwidth}
  \centering
  \makebox[0pt][c]{%
    \includegraphics[width=1.005\textwidth]{figures/line_PVproduction_gridoptim_excfeedin.png}
  }
\end{minipage}\hfill
\begin{minipage}{0.492\textwidth}
  \centering
...
% =======================================
\begin{frame}{\strut DSO Intervention }
\begin{minipage}{0.492\textwidth}
  \centering
  \makebox[0pt][c]{%
    \includegraphics[width=1.005\textwidth]{figures/line_PVproduction_DSOreact_excfeedin.png}
  }
\end{minipage}\hfill
\begin{minipage}{0.492\textwidth}
  \centering
