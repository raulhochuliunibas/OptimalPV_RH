...
def calc_economics_in_topo_df(
    ...
    for i in range(0, len(egids), stepsize):
        ...
        # pvprod method 2.1
            ...
            formla_for_log_print = f"subdf['pvprod_kW'] = subdf['radiation'] / 1000 * inverter_efficiency * share_roof_area_available * subdf['panel_efficiency'] * subdf['FLAECHE'] * subdf['angletilt_factor']"
        ...
        # pvprod method 2.2
            ...
            formla_for_log_print = f"subdf['pvprod_kW'] = subdf['radiation'] / 1000 * inverter_efficiency * share_roof_area_available * subdf['panel_efficiency'] * subdf['FLAECHE']"
        ...
        # pvprod method 3.1
            ...
            formla_for_log_print = f"subdf['pvprod_kW'] = subdf['radiation_rel_locmax'] * kWpeak_per_m2 * inverter_efficiency * share_roof_area_available * subdf['panel_efficiency'] * subdf['FLAECHE'] * subdf['angletilt_factor']"
        ...
        # pvprod method 3.2
            ...
            formla_for_log_print = f"subdf['pvprod_kW'] = subdf['radiation_rel_locmax'] * kWpeak_per_m2 * inverter_efficiency * share_roof_area_available * subdf['panel_efficiency'] * subdf['FLAECHE']"
