...
class VisualSetting:
    def __init__(self, 
                ...
                default_zoom_year: List[int] = [2012, 2030],
        ...
        self.pvalloc_scen_list: list[str] = [scen for scen in scen_in_pvalloc_list if not any(fnmatch.fnmatch(scen, pattern) for pattern in self.pvalloc_exclude_pattern_list)]
