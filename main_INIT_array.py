...
if True: 
    ...
    DEV_newpreprep__scen_list = [
        ...
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{RUR_bfs_name}_max', 
                      bfs_numbers                       = RUR_bfs_list,
        ),
        # make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{RUR_bfs_name}_max_1hll', 
        #               bfs_numbers                       = RUR_bfs_list,
        #               GRIDspec_node_1hll_closed_TF      = True,
        # ),
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{RUR_bfs_name}_gridoptim_max',
                      bfs_numbers                       = RUR_bfs_list,
                      run_pvalloc_initalization_TF      = True,
        ...
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{RUR_bfs_name}_max_sCs4p6',
                        bfs_numbers                       = RUR_bfs_list,
        ...
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{SUB_bfs_name}_max', 
                      bfs_numbers                       = SUB_bfs_list,
        ),
        # make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{SUB_bfs_name}_max_1hll', 
        #               bfs_numbers                       = SUB_bfs_list,
        #               GRIDspec_node_1hll_closed_TF      = True,
        # ),
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{SUB_bfs_name}_gridoptim_max',
                      bfs_numbers                       = SUB_bfs_list,
                      run_pvalloc_initalization_TF      = True,
                      run_pvalloc_mcalgorithm_TF        = False,
                      run_gridoptimized_orderinst_TF    = True,
        ...
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{SUB_bfs_name}_max_sCs4p6',
                        bfs_numbers                       = SUB_bfs_list,
                        GRIDspec_apply_prem_tiers_TF      = True,
                        GRIDspec_subsidy_name             = 'Cs4p6',
        ),

        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{LRG_bfs_name}_max', 
                      bfs_numbers                       = LRG_bfs_list,
        ),
        # make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{LRG_bfs_name}_max_1hll', 
        #               bfs_numbers                       = LRG_bfs_list,
        #               GRIDspec_node_1hll_closed_TF      = True,
        # ),
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{LRG_bfs_name}_gridoptim_max',
                      bfs_numbers                       = LRG_bfs_list,
                      run_pvalloc_initalization_TF      = True,
                      run_pvalloc_mcalgorithm_TF        = False,
                      run_gridoptimized_orderinst_TF    = True,
        ...
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{LRG_bfs_name}_max_sCs4p6',
                        bfs_numbers                       = LRG_bfs_list,
                        GRIDspec_apply_prem_tiers_TF      = True,
                        GRIDspec_subsidy_name             = 'Cs4p6',
        ),

        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{XLRG_bfs_name}_max', 
                      bfs_numbers                       = XLRG_bfs_list,
        ),
        # make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{XLRG_bfs_name}_max_1hll', 
        #               bfs_numbers                       = XLRG_bfs_list,
        #               GRIDspec_node_1hll_closed_TF      = True,
        # ),
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{XLRG_bfs_name}_gridoptim_max',
                      bfs_numbers                       = XLRG_bfs_list,
                      run_pvalloc_initalization_TF      = True,
                      run_pvalloc_mcalgorithm_TF        = False,
                      run_gridoptimized_orderinst_TF    = True,
        ...
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{XLRG_bfs_name}_max_sCs4p6',
                        bfs_numbers                       = XLRG_bfs_list,
                        GRIDspec_apply_prem_tiers_TF      = True,
                        GRIDspec_subsidy_name             = 'Cs4p6',
        ),

        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{X2XL_bfs_name}_max', 
                      bfs_numbers                       = X2XL_bfs_list,
        ),
        # make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{X2XL_bfs_name}_max_1hll', 
        #               bfs_numbers                       = X2XL_bfs_list,
        #               GRIDspec_node_1hll_closed_TF      = True,
        # ),
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{X2XL_bfs_name}_gridoptim_max',
                      bfs_numbers                       = X2XL_bfs_list,
                      run_pvalloc_initalization_TF      = True,
                      run_pvalloc_mcalgorithm_TF        = False,
                      run_gridoptimized_orderinst_TF    = True,
        ...
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{X2XL_bfs_name}_max_sCs4p6',
                        bfs_numbers                       = X2XL_bfs_list,
                        GRIDspec_apply_prem_tiers_TF      = True,
                        GRIDspec_subsidy_name             = 'Cs4p6',
        ),
        ...
        # make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{RUR_bfs_name}_max__preprep_before_Feb26', 
        #             bfs_numbers                       = RUR_bfs_list,
        ...
        # make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{LRG_bfs_name}_max__preprep_before_Feb26', 
        #             bfs_numbers                       = LRG_bfs_list,
        #             #   name_dir_import                   = 'preprep_BLSO_15to24_extSolkatEGID_aggrfarms_reimportAPI-COPYpreprep_used_untilFeb26'
        #             name_dir_import                   = 'preprep_BLSO_15to24_extSolkatEGID_aggrfarms_reimportAPI__before_Feb26',
        #             GWRspec_building_cols             = ['EGID', 'GDEKT', 'GGDENR', 'GKODE', 'GKODN', 'GKSCE', 
    ...
    DEV_OLDpreprep__scen_list = [
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{RUR_bfs_name}_max_OLDpreprep', 
                      bfs_numbers                       = RUR_bfs_list,
                      name_dir_import                   = 'preprep_BLSO_15to24_extSolkatEGID_aggrfarms_reimportAPI__before_Feb26',
        ),
        # make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{RUR_bfs_name}_max_1hll', 
        ...
        #               GRIDspec_node_1hll_closed_TF      = True,
        # ),
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{RUR_bfs_name}_gridoptim_max_OLDpreprep',
                      bfs_numbers                       = RUR_bfs_list,
                      name_dir_import                   = 'preprep_BLSO_15to24_extSolkatEGID_aggrfarms_reimportAPI__before_Feb26',
                      run_pvalloc_initalization_TF      = True,
                      run_pvalloc_mcalgorithm_TF        = False,
        ...
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{RUR_bfs_name}_max_sCs4p6_OLDpreprep',
                        bfs_numbers                       = RUR_bfs_list,
                        name_dir_import                   = 'preprep_BLSO_15to24_extSolkatEGID_aggrfarms_reimportAPI__before_Feb26',
                        GRIDspec_apply_prem_tiers_TF      = True,
                        GRIDspec_subsidy_name             = 'Cs4p6',
        ...
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{SUB_bfs_name}_max_OLDpreprep', 
                      bfs_numbers                       = SUB_bfs_list,
                      name_dir_import                   = 'preprep_BLSO_15to24_extSolkatEGID_aggrfarms_reimportAPI__before_Feb26',
        ),
        # make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{SUB_bfs_name}_max_1hll', 
        ...
        #               GRIDspec_node_1hll_closed_TF      = True,
        # ),
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{SUB_bfs_name}_gridoptim_max_OLDpreprep',
                      bfs_numbers                       = SUB_bfs_list,
                      name_dir_import                   = 'preprep_BLSO_15to24_extSolkatEGID_aggrfarms_reimportAPI__before_Feb26',
                      run_pvalloc_initalization_TF      = True,
                      run_pvalloc_mcalgorithm_TF        = False,
        ...
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{SUB_bfs_name}_max_sCs4p6_OLDpreprep',
                        bfs_numbers                       = SUB_bfs_list,
                        name_dir_import                   = 'preprep_BLSO_15to24_extSolkatEGID_aggrfarms_reimportAPI__before_Feb26',
                        GRIDspec_apply_prem_tiers_TF      = True,
                        GRIDspec_subsidy_name             = 'Cs4p6',
        ...
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{LRG_bfs_name}_max_OLDpreprep', 
                      bfs_numbers                       = LRG_bfs_list,
                      name_dir_import                   = 'preprep_BLSO_15to24_extSolkatEGID_aggrfarms_reimportAPI__before_Feb26',
        ),
        # make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{LRG_bfs_name}_max_1hll', 
        ...
        #               GRIDspec_node_1hll_closed_TF      = True,
        # ),
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{LRG_bfs_name}_gridoptim_max_OLDpreprep',
                      bfs_numbers                       = LRG_bfs_list,
                      name_dir_import                   = 'preprep_BLSO_15to24_extSolkatEGID_aggrfarms_reimportAPI__before_Feb26',
                      run_pvalloc_initalization_TF      = True,
                      run_pvalloc_mcalgorithm_TF        = False,
        ...
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{LRG_bfs_name}_max_sCs4p6_OLDpreprep',
                        bfs_numbers                       = LRG_bfs_list,
                        name_dir_import                   = 'preprep_BLSO_15to24_extSolkatEGID_aggrfarms_reimportAPI__before_Feb26',
                        GRIDspec_apply_prem_tiers_TF      = True,
                        GRIDspec_subsidy_name             = 'Cs4p6',
        ...
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{XLRG_bfs_name}_max_OLDpreprep', 
                      bfs_numbers                       = XLRG_bfs_list,
                      name_dir_import                   = 'preprep_BLSO_15to24_extSolkatEGID_aggrfarms_reimportAPI__before_Feb26',
        ),
        # make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{XLRG_bfs_name}_max_1hll', 
        ...
        #               GRIDspec_node_1hll_closed_TF      = True,
        # ),
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{XLRG_bfs_name}_gridoptim_max_OLDpreprep',
                      bfs_numbers                       = XLRG_bfs_list,
                      name_dir_import                   = 'preprep_BLSO_15to24_extSolkatEGID_aggrfarms_reimportAPI__before_Feb26',
                      run_pvalloc_initalization_TF      = True,
                      run_pvalloc_mcalgorithm_TF        = False,
        ...
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{XLRG_bfs_name}_max_sCs4p6_OLDpreprep',
                        bfs_numbers                       = XLRG_bfs_list,
                        name_dir_import                   = 'preprep_BLSO_15to24_extSolkatEGID_aggrfarms_reimportAPI__before_Feb26',
                        GRIDspec_apply_prem_tiers_TF      = True,
                        GRIDspec_subsidy_name             = 'Cs4p6',
        ...
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{X2XL_bfs_name}_max_OLDpreprep', 
                      bfs_numbers                       = X2XL_bfs_list,
                      name_dir_import                   = 'preprep_BLSO_15to24_extSolkatEGID_aggrfarms_reimportAPI__before_Feb26',
        ),
        # make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{X2XL_bfs_name}_max_1hll', 
        ...
        #               GRIDspec_node_1hll_closed_TF      = True,
        # ),
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{X2XL_bfs_name}_gridoptim_max_OLDpreprep',
                      bfs_numbers                       = X2XL_bfs_list,
                      name_dir_import                   = 'preprep_BLSO_15to24_extSolkatEGID_aggrfarms_reimportAPI__before_Feb26',
                      run_pvalloc_initalization_TF      = True,
                      run_pvalloc_mcalgorithm_TF        = False,
        ...
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'DEV_{X2XL_bfs_name}_max_sCs4p6_OLDpreprep',
                        bfs_numbers                       = X2XL_bfs_list,
                        name_dir_import                   = 'preprep_BLSO_15to24_extSolkatEGID_aggrfarms_reimportAPI__before_Feb26',
                        GRIDspec_apply_prem_tiers_TF      = True,
                        GRIDspec_subsidy_name             = 'Cs4p6',
    ...
    LRG_scen_list = [
        ...
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'{LRG_bfs_name}_max_sCs2p6',
                        GRIDspec_apply_prem_tiers_TF      = True,
                        GRIDspec_subsidy_name             = 'Cs2p6',
        ),
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'{LRG_bfs_name}_max_sCs2p8',
                        GRIDspec_apply_prem_tiers_TF      = True,
                        GRIDspec_subsidy_name             = 'Cs2p8',
        ),
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'{LRG_bfs_name}_max_sCs4p4',
                        GRIDspec_apply_prem_tiers_TF      = True,
        ...
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'{LRG_bfs_name}_max_sCs4p8',
                        GRIDspec_apply_prem_tiers_TF      = True,
                        GRIDspec_subsidy_name             = 'Cs4p8',
        ),
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'{LRG_bfs_name}_max_sCs6p4',
                        GRIDspec_apply_prem_tiers_TF      = True,
                        GRIDspec_subsidy_name             = 'Cs6p4',
        ),
        make_scenario(pvalloc_Xnbfs_ARE_30y_DEFAULT, f'{LRG_bfs_name}_max_sCs6p6',
                        GRIDspec_apply_prem_tiers_TF      = True,
