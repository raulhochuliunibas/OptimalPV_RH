...
#SBATCH --job-name=compGBAUJ10m12c24G                   #This is the name of your job
...
#SBATCH --time=00:10:00        #This is the time that your task will run
...
python exploratory_files/comparison_GBAUJ_preprep+pvalloc__before_after_Feb26.py
