...
if True: 
    ...
    pvalloc_Xnbfs_ARE_20y_OLDPREPREP_1hll = PVAllocScenario_Settings(
        name_dir_export ='pvalloc_29nbfs_20y_prepFeb26',
        name_dir_import = 'preprep_BLSO_15to24_extSolkatEGID_aggrfarms_reimportAPI__before_Feb26',
    ...
    LRG_bfs_name = 'pvalloc_29nbfs_LRG2'
...
if True: 
    ...
    LRG_scen_list = [
        ...
        make_scenario(pvalloc_Xnbfs_ARE_20y_DEFAULT, f'{LRG_bfs_name}_max_epzb0_25', 
                      CSTRspec_ep2050_rescale_fact     = 0.250,
        ),

        make_scenario(pvalloc_Xnbfs_ARE_20y_DEFAULT, f'{LRG_bfs_name}_max_histcnstrcapgr0_02', 
                      CSTRspec_capacity_type           = 'hist_constr_capa_year',
    ...
    LRG_scen_APPEND_list = [
        make_scenario(pvalloc_Xnbfs_ARE_20y_DEFAULT, f'{LRG_bfs_name}_max_epzb1', 
                      CSTRspec_ep2050_rescale_fact     = 1.0,
        ),
        make_scenario(pvalloc_Xnbfs_ARE_20y_DEFAULT, f'{LRG_bfs_name}_max_histcnstrcapgr0_3', 
                      CSTRspec_capacity_type           = 'hist_constr_capa_year',
                      CSTRspec_ann_capacity_growth     = 0.3,
        ),
        make_scenario(pvalloc_Xnbfs_ARE_20y_DEFAULT, f'{LRG_bfs_name}_max_histcnstrcapgr0_2', 
                      CSTRspec_capacity_type           = 'hist_constr_capa_year',
                      CSTRspec_ann_capacity_growth     = 0.2,
        ),
        make_scenario(pvalloc_Xnbfs_ARE_20y_DEFAULT, f'{LRG_bfs_name}_max_histcnstrcapgr0_1', 
                      CSTRspec_capacity_type           = 'hist_constr_capa_year',
                      CSTRspec_ann_capacity_growth     = 0.1,
        ),
        make_scenario(pvalloc_Xnbfs_ARE_20y_DEFAULT, f'{LRG_bfs_name}_max_pksh991',
                      GRID_peak_shaving_enabled_tupl  = (True, 99, 1), 
        ),
        make_scenario(pvalloc_Xnbfs_ARE_20y_DEFAULT, f'{LRG_bfs_name}_max_pksh',
                      GRID_peak_shaving_enabled_tupl  = (True, 0.9, 0.7),
        ),
        make_scenario(pvalloc_Xnbfs_ARE_20y_DEFAULT, f'{LRG_bfs_name}_max_pksh_sCs2p8',
                        GRIDspec_apply_prem_tiers_TF      = True,
                        GRIDspec_subsidy_name             = 'Cs2p8',
                      GRID_peak_shaving_enabled_tupl  = (True, 0.9, 0.7),
        ),
        make_scenario(pvalloc_Xnbfs_ARE_20y_DEFAULT, f'{LRG_bfs_name}_max_pksh_sCs4p8',
                        GRIDspec_apply_prem_tiers_TF      = True,
                        GRIDspec_subsidy_name             = 'Cs4p8',
                      GRID_peak_shaving_enabled_tupl  = (True, 0.9, 0.7),
        ),
        make_scenario(pvalloc_Xnbfs_ARE_20y_DEFAULT, f'{LRG_bfs_name}_max_pksh_sCs6p8',
                        GRIDspec_apply_prem_tiers_TF      = True,
                        GRIDspec_subsidy_name             = 'Cs6p8',
                      GRID_peak_shaving_enabled_tupl  = (True, 0.9, 0.7),
        ),
...
def get_subscen_list(sub_scen_str = 'test'):
    if sub_scen_str == 'test':
        ...
        return LRG_OLDpreprep__scen_list
