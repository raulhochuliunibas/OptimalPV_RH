...
pvalloc_scen_list = [
    ...
    PVAllocScenario_Settings(
        ...
        ALGOspec_topo_subdf_partitioner = 9999, 
        TECspec_pvprod_calc_method = 'method2.2',
        MCspec_montecarlo_iterations = 1
        ),

    # pvalloc_BLsml_3m_f2020_1mc_npv.part9999_pandas
    PVAllocScenario_Settings(
        name_dir_export    = 'pvalloc_BLsml_3m_f2020_1mc_npv.part9999_pandas',
        name_dir_import    = 'preprep_BL_22to23_extSolkatEGID',
        show_debug_prints  = True,
        bfs_numbers        = [
            2768, 2761, 2772, 2785, 2787,
    ...
    # pvalloc_BLsml_3y_f2020_1mc_npv.part9999_polars
    PVAllocScenario_Settings(
        name_dir_export    = 'pvalloc_BLsml_3y_f2020_1mc_npv.part9999_polars',
        name_dir_import    = 'preprep_BL_22to23_extSolkatEGID',
        show_debug_prints  = True,
        bfs_numbers        = [
            2768, 2761, 2772, 2785, 2787,
    ...
    # pvalloc_BLsml_3y_f2020_1mc_npv.part9999_pandas
    PVAllocScenario_Settings(
        name_dir_export    = 'pvalloc_BLsml_3y_f2020_1mc_npv.part9999_pandas',
        name_dir_import    = 'preprep_BL_22to23_extSolkatEGID',
        show_debug_prints  = True,
        bfs_numbers        = [
            2768, 2761, 2772, 2785, 2787,
